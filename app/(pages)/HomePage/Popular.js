                    ...
                    {props?.popularData?.data?.map((data, index) => {
                        return (
                            <Link href={{ pathname: `/detail/${data?._id}` }} className='poularWeekCard flex items-center group py-2'>
                                ...
                                <div className='text-xs md:text-sm group-hover:border-2 group-hover:border-[#CD3D73] overflow-hidden pl-1 md:pl-5 border rounded-r-md dark:bg-gray-900 bg-gray-300 h-24 md:h-36 w-1/2 flex flex-col justify-center'>
