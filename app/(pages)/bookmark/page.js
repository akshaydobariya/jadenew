            ...
            {bookmarkNovelData.length == 0 ?
                ...
                <div className='grid grid-cols-2 lg:grid-cols-4 md:gap-8 gap-3'>
                    {bookmarkNovelData?.map((item, i) => {
                        return (
                            <div key={i} className='relative flex flex-col border-pink-400 border-2 shadow-lg cursor-pointer dark:border-gray-700 bg-gray-100 dark:bg-[#202020] rounded-md'>
                                ...
                                <div className='flex justify-between w-full pb-2'>
                                    <Link href={{ pathname: `/detail/${item?.novelId?._id}` }} className='flex flex-col justify-between pl-2 pt-1'>
                                        ...
                                        <div className='text-sm text-gray-500 md:pt-2'>You have read 1/129</div>
