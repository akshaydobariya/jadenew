...
function page() {
    return (
        <div className='pt-20 pb-72 px-10 lg:px-72'>
            ...
            <div className='flex justify-between pb-2 border-b-2 hover:bg-gray-200 px-2 text-gray-700 dark:text-gray-200'>
                <div>
            ...
            <div className='flex justify-between py-2 border-b-2 hover:bg-gray-200 px-2 text-gray-700 dark:text-gray-200'>
                <div>
                    <div>Read Now For free</div>
                    <div className=''>cols bloded</div>
                </div>
            ...
            <div className='flex justify-between pb-2 pt-2 hover:bg-gray-200 px-2 text-gray-700 dark:text-gray-200'>
                <div>
                    <div>Read Now For free</div>
                    <div className=''>cols bloded</div>
                </div>
