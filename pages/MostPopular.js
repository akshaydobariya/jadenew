    ...
    return (
        <div className='md:mt-16 mt-10 bg-gray-800 py-10 md:px-8 px-2'>
            ...
            <div className='flex flex-col md:flex-row'>
                    ...
                    {props?.popular?.map((item, index) => {
                        return (
                            <div key={index} className='cardPopular cursor-pointer border-gray-500 border rounded-md'>
                                <div className='md:h-44 md:w-48 h-28 w-28 object-cover overflow-hidden'>
                ...
                <div className='border border-gray-600 rounded-md md:w-[30%] w-[100%] flex md:flex-col justify-center items-center md:p-10 mr-6'>
