        ...
        <div className='md:pt-16 pt-10 px-4 md:px-8'>
            <div className='flex justify-between items-center'>
                <div className='text-start pb-5'>
                    <div className='text-2xl md:text-3xl font-semibold heading'>New Release</div>
                    ...
                    {props.NewReleaseData.map((item, index) => {
                        return (
                            <div className='releaseCard'>
                                <div key={index} className='h-40 md:h-64 w-56 releaseImageParent'>
                                    <Image src={item.image} alt='' className='h-full rounded-lg releaseImage' />
                                </div>
                                <div className="details">
                                    <div className="center">
                                        <div className='releaseName text-sm'>{item.name}</div>
                                        <p className='text-sm'>Lorem ipsum is simple dummy text on the printing and typesetting industry.</p>
                                    </div>
                                </div>
                            </div>
                        )
